...
import com.harsh.sbet.landon.roomwebapp.async.RoomCleanerListener;
...
public class AsyncConfig {
    ...
    public MessageListenerAdapter listenerAdapter(RoomCleanerListener listener){
        return new MessageListenerAdapter(listener,"recieveMessage");
    }
    @Bean
